...
提交前检查四件事：用户要求和 developments 是否都拍到了；每个切点是否有上述必要理由，合并后会损失什么或违反哪项指定结构；每镜的画面、动作和摄影机是否具体可拍；前后镜的动作、物品、关键帧、声音和转场是否接得上。锁定后交给 Sound Planning Skill；后续只排版，不重新设计镜头。
