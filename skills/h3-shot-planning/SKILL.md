...
在 `[Shot N]` 正文中依次写清：开头先看见谁和什么，它们在哪里、处于什么状态；人物或物体接下来怎样运动、状态怎样改变；用户要求的材质、结构、文字或表情在什么画面和光线下看清；摄影机怎样跟随或重新构图；结束时留下什么画面和状态。不要只写“展示产品”“人物反应”或一个景别名称，让后续步骤猜镜头内容。对参与动作的物品，写清它在动作开始前在哪里、由谁持有或处于什么状态，再写它如何改变。只交代与本镜动作或后续镜头有关的主体，不逐一罗列背景物。
